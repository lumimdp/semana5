...
public final class ConstantesBaseDatos {
    ...
    public static final String TABLE_HUESEOS = "mascotas_hueseos" ;
    public static final String TABLE_HUESEOS_ID = "id";
    public static final String TABLE_HUESEOS_ID_MASCOTA = "id_mascota";
    public static final String TABLE_HUESEOS_HUESEOS = "hueseos";
}
